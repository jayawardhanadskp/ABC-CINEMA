            ...
            <div class="col-lg-6">
                <div class="contact-form bg-light p-5">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <input type="text" name="subject" class="form-control border-0" placeholder=" Enter The Subject" style="height: 55px;">
                        </div>
                        <div class="col-12">
                            <textarea class="form-control border-0" name="message" rows="4" placeholder=" Enter Message"></textarea>
                        </div>
                        <div class="col-12">
