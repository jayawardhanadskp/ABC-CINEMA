        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                <a href="index.jsp" class="nav-item nav-link ">Home</a>
                    ...
                    <a href="log-in.jsp" class="nav-item nav-link active">Log In</a>
            </div>
        </div>
    </nav>
</div>
<!-- Navbar End -->
    ...
    <div class="container-fluid page-header">
        ...
        <div class="d-inline-flex text-white">
            ...
            <h6 class="text-uppercase text-white m-0">Log-In</h6>
        </div>
    </div>
    <!-- Page Header Start -->
                    ...
                    <div class="card border-4"  style="margin: 150px 0px;"   >
                        ...
                        <div class="card-body rounded-bottom bg-white p-5">
                            ...
                            <form action="LoginServlet" method="POST">
                                ...
                                <div>
                                    <center>
                                    <button class="btn btn-primary btn-block py-3 p-5" type="submit">Log-In</button>
                                     <button class="btn btn-primary btn-block py-3 p-5" type="reset">Clear</button>
                                    </center>
                                </div>
                            </form>
                        </div>
